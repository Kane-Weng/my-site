...
### Mechanical Design & Fabrication (Year 1)
I managed the full mechanical lifecycle of robotic arm components using Siemens NX and CNC machining.
...
### Autonomy & Perception Stack (Year 2)
Currently, I am upgrading the rover’s intelligence using the ROS 2 framework to improve spatial awareness. 
